...
const WELCOME_MESSAGE: Message = {
  id: 'welcome',
  role: 'assistant',
  content: "Hello! I'm **Nexus** — your AI-powered trading coach built on TraderEdge Pro's proprietary analysis system.\n\n**What makes me different?**\nI combine advanced AI reasoning with our specialized trading intelligence:\n• **SMC & IPDA Analysis** - Order blocks, FVGs, liquidity sweeps\n• **Your Trade Context** - I see your open positions & risk profile\n• **Prop Firm Compliance** - FTMO, Funded Next rules built-in\n• **Real-time Market Data** - Live prices, ATR, session timing\n\n**I can help you with:**\n• Trade analysis and strategy feedback\n• Risk management optimization\n• Trading psychology and mindset\n• Prop firm rule compliance\n\nHow can I help you today?",
  timestamp: new Date()
};
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Your AI × Our Trading Intelligence</p>
            </div>
          </div>
             ...
             <Dialog open={showSettings} onOpenChange={setShowSettings}>
               <DialogTrigger asChild>
                 <Button variant="outline" size="sm" className="gap-2">
                   ...
                   {hasApiKey ? 'Settings' : 'Connect AI Engine'}
                 </Button>
               </DialogTrigger>
