...
const { handleAICoach } = require('./ai-coach-handler');
const { handlePublicAIChat } = require('./public-ai-chat-handler');
...
// ==================== AI COACH (Direct Handler) ====================

// AI Coach handled directly to bypass Supabase edge function plan limits
app.post('/api/functions/ai-coach', handleAICoach);

// ==================== PUBLIC AI CHAT - ZOE (Direct Handler) ====================

// Public AI Chat (Zoe) handled directly to bypass Supabase edge function
app.post('/api/functions/public-ai-chat', handlePublicAIChat);
